...
/***/ 146:
/*!********************************************************************************!*\
  !*** E:/yuanshenghang/ysh-uniapp/main.js?{"page":"pages%2Fmessage%2Fmessage"} ***!
  \********************************************************************************/
...
var _message = _interopRequireDefault(__webpack_require__(/*! ./pages/message/message.vue */ 147));
// @ts-ignore
...
/***/ 147:
/*!*************************************************************!*\
  !*** E:/yuanshenghang/ysh-uniapp/pages/message/message.vue ***!
  \*************************************************************/
/*! no static exports found */
...
/***/ 148:
/*!********************************************************************************************!*\
  !*** E:/yuanshenghang/ysh-uniapp/pages/message/message.vue?vue&type=template&id=a91f51d4& ***!
  \********************************************************************************************/
...
/***/ 149:
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/yuanshenghang/ysh-uniapp/pages/message/message.vue?vue&type=template&id=a91f51d4& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 150:
/*!**************************************************************************************!*\
  !*** E:/yuanshenghang/ysh-uniapp/pages/message/message.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 151:
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/yuanshenghang/ysh-uniapp/pages/message/message.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  methods: {
    ...
    loadMessageList: function loadMessageList() {
      ...
      // 模拟数据
      for (var i = 1; i <= 10; i++) {
        var id = (this.page - 1) * 10 + i;
        newMessages.push({
          id: id,
          name1: "\u5BA2\u6237".concat(id),
          name2: "\u4EA7\u54C1\u5458".concat(id % 3 + 1),
          name3: "\u4E1A\u52A1\u5458".concat(id % 5 + 1),
          content: "\u8FD9\u662F\u4E00\u6761\u6D4B\u8BD5\u6D88\u606F\uFF0C\u5185\u5BB9\u4E3A\u5BA2\u6237\u8D44\u6599\u53D8\u66F4\u901A\u77E5\uFF0C\u8BF7\u53CA\u65F6\u5904\u7406\u3002\u6D88\u606FID: ".concat(id),
      ...
      if (this.page === 1) {
        ...
        this.messageList = [].concat((0, _toConsumableArray2.default)(this.messageList), newMessages);
      }
    },
    // 生成随机日期
    generateRandomDate: function generateRandomDate() {
      var now = new Date();
      var days = Math.floor(Math.random() * 7);
      var hours = Math.floor(Math.random() * 24);
      var minutes = Math.floor(Math.random() * 60);
      var date = new Date(now.getTime() - (days * 24 * 60 * 60 * 1000 + hours * 60 * 60 * 1000 + minutes * 60 * 1000));
    ...
    showMessageDetail: function showMessageDetail(item) {
      // 标记为已读
      if (!item.read) {
        var index = this.messageList.findIndex(function (msg) {
    ...
    handleDelete: function handleDelete(id) {
      ...
      uni.showModal({
        ...
        success: function success(res) {
          if (res.confirm) {
            // 模拟删除操作
            _this.messageList = _this.messageList.filter(function (item) {
              return item.id !== id;
            });
            _this.selectedMessages = _this.selectedMessages.filter(function (item) {
              return item !== id;
            });
            uni.showToast({
              title: '删除成功',
    ...
    handleMarkAllRead: function handleMarkAllRead() {
      ...
      uni.showModal({
        ...
        success: function success(res) {
          if (res.confirm) {
            _this2.messageList.forEach(function (item) {
              item.read = true;
            });
            uni.showToast({
              title: '已全部标记为已读',
    ...
    handleDeleteSelected: function handleDeleteSelected() {
      ...
      uni.showModal({
        title: '提示',
        content: "\u786E\u5B9A\u8981\u5220\u9664\u5DF2\u9009\u4E2D\u7684 ".concat(this.selectedMessages.length, " \u6761\u6D88\u606F\u5417\uFF1F"),
        success: function success(res) {
          if (res.confirm) {
            // 模拟删除操作
            _this3.messageList = _this3.messageList.filter(function (item) {
              return !_this3.selectedMessages.includes(item.id);
            });
            _this3.selectedMessages = [];
            uni.showToast({
              title: '删除成功',
              icon: 'success'
            });
    ...
    handleSendSMS: function handleSendSMS(item) {
      uni.showModal({
        title: '发送短信',
        content: "\u786E\u5B9A\u8981\u7ED9".concat(item.name1, "\u53D1\u9001\u77ED\u4FE1\u5417\uFF1F"),
        success: function success(res) {
          if (res.confirm) {
            uni.showToast({
              title: '短信发送成功',
...
/***/ 152:
/*!**********************************************************************************************!*\
  !*** E:/yuanshenghang/ysh-uniapp/pages/message/message.vue?vue&type=style&index=0&lang=css& ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 153:
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/yuanshenghang/ysh-uniapp/pages/message/message.vue?vue&type=style&index=0&lang=css& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
